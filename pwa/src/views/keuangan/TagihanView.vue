  ...
  <div class="min-h-screen bg-[#F5F7FA] pb-nav">
    ...
    <div class="relative bg-gradient-to-br from-brand-700 to-brand-800 px-5 pt-12 pb-20 overflow-hidden">
      ...
      <div class="relative flex items-center gap-3">
        ...
        <div>
          <p class="text-white/60 text-xs font-medium">Tagihan & Pembayaran</p>
        ...
        <form @submit.prevent="submitUpload" class="flex flex-col gap-4">
          <div>
            ...
            <label class="flex flex-col items-center justify-center w-full h-32
                          border-2 border-dashed rounded-2xl cursor-pointer transition-colors active:bg-gray-50"
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="uploadForm.nominal" type="number" inputmode="numeric" placeholder="0"
                     class="w-full pl-10 pr-4 py-3.5 rounded-xl border border-gray-200 text-gray-800
                            ...
                            focus:border-brand-400 bg-gray-50 transition-colors" required />
            </div>
          </div>
          ...
          <div v-if="uploadError" class="bg-red-50 border border-red-100 rounded-xl px-4 py-3 text-red-600 text-sm font-medium">
            {{ uploadError }}
          </div>
